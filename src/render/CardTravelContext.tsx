...
import { cardDeckTravelEndpoints, cardHandTravelEndpoints } from './cardLayout'
...
type CardTravelDirection = 'toDeck' | 'fromDeck'
...
export function CardTravelProvider(props: Readonly<{ children: ReactNode }>) {
  ...
  return (
    <CardTravelContext.Provider
      value={{ deckInspectImageRef, travelingCardKey, travelCardToDeck, travelCardFromDeck }}
    >
      {children}
      {flyer}
    </CardTravelContext.Provider>
...
function CardTravelFlyer(props: Readonly<{
  ...
  const { flight, pos, onToDeckFlipEnd, onToDeckTravelEnd, onFromDeckTravelEnd, onFromDeckFlipEnd } = props
      ...
      >
        <div
          ...
          onTransitionEnd={(e) => {
            ...
            if (!fromDeck && flight.flipped && !moving) onToDeckFlipEnd()
